"""
Embedding Model Report - Simple script to identify the embedding model used in ChromaDB
"""
import chromadb

def identify_embedding_model():
    """
    Identify the embedding model used in ChromaDB by testing with different dimensions
    """
    ...
    print("Identifying embedding model used in ChromaDB...")
    ...
    for collection in collections:
        ...
        for dim in [1536, 768, 384, 512, 1024]:
            try:
                ...
                if "dimension mismatch" in str(e).lower() or "expecting embedding with dimension" in str(e).lower():
                    expected_dim = None
